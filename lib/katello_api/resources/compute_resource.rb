module KatelloApi
  module Resources
    class ComputeResource < KatelloApi::Base
      ...
      #   * provider [String, nil]  providers include libvirt, ovirt, ec2, vmware, openstack, rackspace, gce 
      ...
      # @param [Hash] headers additional http headers
      # @return [Array] First item: parsed data; second item: raw body
      def available_clusters(params = {}, headers = {})
        perform_call(__method__, params, headers)
      end
      ...
      # @param [Hash] headers additional http headers
      # @return [Array] First item: parsed data; second item: raw body
      def available_networks(params = {}, headers = {})
        perform_call(__method__, params, headers)
      end
      ...
      # @param [Hash] headers additional http headers
      # @return [Array] First item: parsed data; second item: raw body
      def available_storage_domains(params = {}, headers = {})
        perform_call(__method__, params, headers)
      end
